...
class Payment(Base):
    ...
    customer = relationship(
        "Customer",
        primaryjoin="and_(Payment.customer_id==Customer.id, Payment.merchant_id==Customer.merchant_id)",
        foreign_keys=[customer_id, merchant_id],
        back_populates="payments",
    )
    recovery_case = relationship(
        "RecoveryCase",
        primaryjoin="and_(Payment.id==RecoveryCase.payment_id, Payment.merchant_id==RecoveryCase.merchant_id)",
        foreign_keys="[RecoveryCase.payment_id, RecoveryCase.merchant_id]",
